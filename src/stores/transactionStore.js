...
export const useTransactionStore = defineStore('transaction', {
    ...
    actions: {
        ...
        // total revenue of all restaurants / revenue generated by Ahago
        async getAllGeneratedRevenue() {
            try {
                const response = await TransactionService.getRevenue();
                this.adminRevenue = response.data;
                console.log('adminRevenue = ', this.adminRevenue)
            } catch (err) {
                console.log(err)
            }
        },
